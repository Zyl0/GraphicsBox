...
namespace  GLTF
{
    ...
    void LoadSceneTree(
        ...
        int node,
        CPUScene& outScene, const Math::WorldTransformF& parent = Math::WorldTransformF()
        )
    {
        ...
        Math::WorldTransformF& TransformObject = outScene.transforms.back();
        
        TransformObject = GetNodeWorldTransform(model, NodeObject);
        TransformObject = parent * TransformObject;
        
        Math::WorldTransformF NewParentTransform = TransformObject;
    ...
    void LoadSceneTree(
        const tinygltf::Model& model,
        int node,
        GPUScene& outScene, const Math::WorldTransformF& parent = Math::WorldTransformF()
        )
    {
        const auto& NodeObject = model.nodes[node];
