    ...
    namespace _ECS
    {
        ...
        public:
            ...
            void Update(double DeltaTime) override
            {
                ...
                if constexpr (HasUpdateComponent)
                {
                    for (size_t i = 0; i < m_Components.size(); ++i)
                    {
                        ...
                        m_System.Update(m_Components[i].Component, m_Components[i].ActorRef, DeltaTime);
                    }
                }
            }
            ...
            void Destroy(Handle Component) override
            {
                ...
                {
                    m_System.Terminate(m_Components[Component].Component, m_Components[Component].ActorRef);
                }
