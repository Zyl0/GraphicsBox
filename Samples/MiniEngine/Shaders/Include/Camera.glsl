...
vec4 ViewToProj(in CameraData Camera, vec4 Position)
{
    return Camera.Camera_ViewToProj * Position;
}

vec3 ViewToProj(in CameraData Camera, vec3 Vector)
{
    return (Camera.Camera_ViewToProj * vec4(Vector, 0.0f)).xyz;
}
